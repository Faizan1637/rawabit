...
const DeleteProfile = () => {
  ...
  const [modal, contextHolder] = Modal.useModal() // Use AntD's useModal hook
    ...
    >
      <div className="space-y-3">
        ...
        <p className="text-slate-600 text-sm">
          This action <strong>cannot be undone</strong>. All your profile data, messages, and preferences will be permanently deleted.
        </p>
      </div>
    </Modal>
  )
  ...
  return (
    <>
      {contextHolder} {/* Required for modal.success/error */}
      {confirmModal}  {/* Controlled confirmation modal */}
